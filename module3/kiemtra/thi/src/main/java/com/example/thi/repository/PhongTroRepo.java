...
public class PhongTroRepo implements IPhongTroRepo {
    ...
    private static final String SEARCH_DTO = "SELECT phongtro.id , phongtro.name, phoneNumber,startDate, description, thanhtoan.thanhtoan as thanhtoan from phongtro join thanhtoan on thanhtoan.id = phongtro.thanhtoan_id where phongtro.name like concat ('%', ?, '%') and thanhtoan.id = ?;";
